...
import  find_library
from    numerical.config          import  SpectralMethodArguments
...
# %%
args = SpectralMethodArguments(equation='boltzmann', is_fast=True)
print(args)
...
sm_object = FastSM_Boltzmann_VHS(
    ...
    quad_order_uniform  = args.quad_order_uniform,
    quad_order_legendre = args.quad_order_legendre,
    quad_order_lebedev  = args.quad_order_lebedev,
)
...
for cnt, t_curr in enumerate(tqdm(arr_t[:-1])):
    # Update the function
