...
from    deep_numerical.neural.layer import  MLP, GraphKernelLayer
from    torch_geometric.data    import  Data


__all__ = ["GraphNeuralOperator", "GNO", "GKN", "GraphKernelNetwork",]
...
GraphKernelNetwork = GraphNeuralOperator
