...
class SpectralMethodArguments():
    def __init__(
        ...
        self._args__maxwellian_mean_velocity:     Optional[np.ndarray]    = None
        self._args__maxwellian_mean_temperature:  Optional[float]         = None
        self._args__multimodal_num_modes:         Optional[int]           = None
        self._args__multimodal_mean_density:      Optional[np.ndarray]    = None
        self._args__multimodal_mean_velocity:     Optional[np.ndarray]    = None
        self._args__multimodal_mean_temperature:  Optional[np.ndarray]    = None
        self._args__multimodal_weights:           Optional[np.ndarray]    = None
    ...
    @property
    def multimodal_mean_density(self) -> np.ndarray:
        return self._args__multimodal_mean_density
    @property
    def multimodal_mean_velocity(self) -> np.ndarray:
        return self._args__multimodal_mean_velocity
    @property
    def multimodal_mean_temperature(self) -> np.ndarray:
        return self._args__multimodal_mean_temperature
    @property
    def multimodal_weights(self) -> np.ndarray:
    ...
    def _set_problem_details(self) -> None:
        ...
        ### Maxwellian ###
            ...
            self._args__maxwellian_mean_velocity:     np.ndarray  = \
                np.array(prob_details['initial_condition']['velocity'][:self.dimension], dtype=np.float64)
        ...
        ### multimodal ###
            ...
            self._args__multimodal_mean_density:         np.ndarray  = \
                np.array(
                    [
            ...
            self._args__multimodal_mean_velocity:        np.ndarray  = \
                np.array(
                    [
            ...
            self._args__multimodal_mean_temperature:     np.ndarray  = \
                np.array(
                    [
            ...
            self._args__multimodal_weights:              np.ndarray  = \
                np.array(
