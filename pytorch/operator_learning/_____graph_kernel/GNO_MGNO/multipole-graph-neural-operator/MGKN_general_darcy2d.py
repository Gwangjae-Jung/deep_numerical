    ...
    def forward(self, data):
        ...
        for t in range(self.depth):
            ...
            for l in reversed(range(self.level)):
                ...
                x[self.points[l]:self.points[l+1]] = y
...
TRAIN_PATH = f"E:/PDE_datasets/from_pde_dataset/Darcy flow/Darcy{s0}_1.npz"
TEST_PATH  = f"E:/PDE_datasets/from_pde_dataset/Darcy flow/Darcy{s0}_2.npz"
