...
class MGKN(torch.nn.Module):
    ...
    def forward(self, data):
        # Load data
        X_list,_, edge_index_list, edge_attr_list = data    # Ignored entry: `y`
        level = len(X_list)
        x = X_list[0]
...
depth = 4  #T
edge_features = 4
theta_d = 1 # dim_domain
node_features = 1 + theta_d # in_channels
...
# The finest graph is the full graph which is obtained "after prior downsampling"
